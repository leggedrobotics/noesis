...
int main(int argc, char** argv)
{
  ...
  using Environment = noesis::gym::CartpoleEnvironment;
  using Visualizer = noesis::gym::CartpoleVisualizer;
  ...
  noesis::init("noesis_rl_train_cartpole_ppo_example");
  ...
  auto logger = std::make_unique<Logger>("", "Cartpole", "Logger", scope, verbose);

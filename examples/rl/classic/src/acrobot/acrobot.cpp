...
int main(int argc, char** argv)
{
  ...
  using Environment = noesis::gym::AcrobotEnvironment;
  using Visualizer = noesis::gym::AcrobotVisualizer;
  ...
  noesis::init("noesis_rl_train_acrobot_ppo_example");
  ...
  auto logger = std::make_unique<Logger>("", "Acrobot", "Logger", scope, verbose);
